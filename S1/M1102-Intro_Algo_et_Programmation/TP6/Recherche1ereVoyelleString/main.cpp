/*
 Programme : Recherche1ereVoyelleString
 But : Déterminer et afficher la première voyelle d'un tableau de caractères saisis par l'utilisateur
...
int main()
{
    ...
    int i = 0; // Initialisation de la recherche
    ...
    // Rechercher la première voyelle
    while (true)
    {
        if (i == tailleTab)
        {
            break; // On sort de la boucle si on est à la fin du tableau
        }
        else
        {
