                                                           ...
                                                           title)
{
	...
	topSizer->Add(sizerSaisie, 1, wxEXPAND|wxALL, 5);
    ...
    topSizer->SetSizeHints(this); // paramétrage de la taille minimale de la fenêtre*/
}
