...
public :
    ...
    int getSourisX() const; // retourne la dernière position en X de la souris
    int getSourisY() const; // retourne la dernière position en Y de la souris
    int getSourisBouton() const;// retourne le dernier bouton activé de la souris
